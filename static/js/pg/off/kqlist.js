...
data.pageNo = pageNo;
  ...
  $.ajax({
      ...
      dataType:'json',
      type:'post',
      url:baseUri+'/office/selectDKList',
          ...
          if(obj.data.list.length===0){
            ...
            $('#totalPageNum1').html(0);
              ...
              for(var i =0;i<obj.data.list.length;i++){
                  ...
                  if(o.checkType==0){
                      statestr = `上班（正常）`;
                  }else if(o.checkType==1){
                      statestr = `<span style="color:red">迟到</span>`;
                  }else if(o.checkType==2){
                      statestr = `<span style="color:red">早退</span>`;
                  }else if(o.checkType==3){
                      statestr = '下班（正常）'; 
                  }
                  ...
                  let typestr = '';
                  if(o.type==0){
                    typestr = `<span style="color:green">上班打卡</span>`;
                  }else if(o.type==1){
                    typestr = `<span style="color:blue">下班打卡</span>`;
                  }else if(o.type==2){
                    typestr = '已驳回'; 
                  }else if(o.type==3){
                    typestr = '已退回'; 
